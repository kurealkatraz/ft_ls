...
/*   Updated: 2015/01/22 20:05:40 by mgras            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_all	*ft_new_fina_next(t_all *a, char *file_name, char *path)
{
	...
	new_a->full = (char*)malloc(sizeof(char) * (ft_strlen(path) + ft_strlen(file_name) + 2));
	new_a->full = ft_strclip(path, file_name, new_a->full);
